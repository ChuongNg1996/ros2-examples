...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<msg_srv_ex::srv::AddThreeInts>::SharedPtr client =                        
    node->create_client<msg_srv_ex::srv::AddThreeInts>("add_three_ints");                  

  auto request = std::make_shared<msg_srv_ex::srv::AddThreeInts::Request>();               
