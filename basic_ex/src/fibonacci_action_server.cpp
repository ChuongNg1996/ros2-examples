/*
LINK: https://docs.ros.org/en/foxy/Tutorials/Intermediate/Writing-an-Action-Server-Client/Cpp.html#writing-an-action-server-and-client-c
*/
...
private:
  ...
  // Start with the callback for HANDLING NEW GOALS
  ...
  // callbacks ACCEPT a new goal and starts PROCESSING it
